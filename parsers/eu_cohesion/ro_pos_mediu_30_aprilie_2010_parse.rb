...
class EuCohesion::RoPosMediu30Aprilie2010Parse
  ...
  def perform result
    ...
    uri = 'http://localhost:9999/Lista_contractate_POS_Mediu_30_aprilie_2010.pdf'
  ...
  def fix_texts texts
    ...
    texts.each_with_index do |text, index|
      if text.left == '174' && (upto = lefts.last(lefts.size - (index +1)).index('174'))
        if upto > 0
          upto.times do |i|
            i = i + 1
  ...
  def parse resource
    ...
    groups = get_text_groups(resource, formats, 'text[@font="2"]') do |xml|      
      ...
      xml.sub!('<text top="819" left="1057" width="96" height="15" font="2"><b>4.596.790.582</b></text>
<text top="819" left="1221" width="83" height="15" font="2"><b>841.032.526</b></text>
<text top="819" left="1367" width="83" height="15" font="2"><b>116.066.201</b></text>
<text top="819" left="1488" width="96" height="15" font="2"><b>1.549.045.354</b></text>
<text top="820" left="1610" width="96" height="15" font="2"><b>7.102.934.663</b></text>
<text top="819" left="522" width="58" height="15" font="2"><b>TOTAL</b></text>', '')
    ...
    write_csv attribute_keys, attribute_keys, 'eu_cohesion/ro_pos_mediu_30_aprilie_2010.csv'
  end
