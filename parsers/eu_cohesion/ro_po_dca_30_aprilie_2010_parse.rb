...
class EuCohesion::RoPoDca30Aprilie2010Parse
  ...
  def perform result
    ...
    uri = 'http://localhost:9999/Lista_contractate_PO_DCA_30_aprilie_2010.pdf'
  ...
  def fix_texts texts
    ...
    texts.each_with_index do |text, index|
      if text.left == '192' && (upto = lefts.last(lefts.size - (index +1)).index('192'))
        if upto > 0
          upto.times do |i|
            i = i + 1
  ...
  def parse resource
    ...
    groups = get_text_groups(resource, formats, 'text[@font="2"]') do |xml|      
      ...
      xml.sub!('<text top="320" left="1061" width="78" height="14" font="2"><b>172.633.080</b></text>
<text top="320" left="1211" width="63" height="14" font="2"><b>6.930.835</b></text>
<text top="320" left="1355" width="70" height="14" font="2"><b>25.137.890</b></text>
<text top="320" left="1489" width="63" height="14" font="2"><b>5.070.538</b></text>
<text top="320" left="1597" width="78" height="14" font="2"><b>209.772.344</b></text>
<text top="320" left="532" width="55" height="14" font="2"><b>TOTAL</b></text>', '')
    ...
    write_csv attribute_keys, attribute_keys, 'eu_cohesion/ro_po_dca_30_aprilie_2010.csv'
  end
